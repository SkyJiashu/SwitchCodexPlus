...
function Show-ProcessSummary {
    ...
    Write-Section "Ports 9229 / 57321"
    Get-NetTCPConnection -LocalAddress 127.0.0.1 -LocalPort 9229,57321 -ErrorAction SilentlyContinue |
...
$backup = "$SettingsPath.bak-standard-$(Get-Date -Format yyyyMMddHHmmss)"
...
Set-JsonProperty $settings "codexAppModelWhitelistUnlock"  $false
